...
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String, Object> param, String host, String port) {
    ...
    public static String doPost3(String url, Map<String, String> param) {
        if (!url.startsWith("http")) {
            url = "http://".concat(url);
        }
        // 创建Httpclient对象
    ...
    public static String doPostJsonByProxy(String url, String json, String host, String port) {
        // 创建Httpclient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
        CloseableHttpResponse response = null;
        String resultString = "";
